...
최신 실행: [v038 — 뒤쪽 접힘을 유지한 앞면 미세 보정](avatar_modeling/v038_knee_front/REVIEW.md). v030에서 앞쪽38위치의 웨이트만 작게 조정했고120도 최대 이동은2.574mm입니다. 뒤쪽 위치와 원래 교차 면 쌍을 유지하며,1377/124/384/재생365표본에서 새 교차·면적 경고가 추가되지 않았습니다. **검수 후보이며 v030 시각 기준·v037 미채택을 유지합니다.** 원래 안쪽 주름·교차는 남습니다.
...
**공유본 기준: 2026-09-09, v038 앞면 미세 보정 비교까지. 사용자 최종 채택 및 전체 관절·VRChat 구동은 미완료입니다. 아래는 각 이전 단계 당시 기록입니다.**
