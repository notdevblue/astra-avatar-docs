...
[실제 모델 전후 갤러리](GALLERY.md) · [공유용 Markdown 문서](GALLERY.md) · [텍스처 전후 비교](../v005_texture/GALLERY.md) · 웨이트 단계 검증 (공유본 미포함: `final_verification.json`) · 컷 포함 최종 파일 검증 (공유본 미포함: `knee_cut_final_verification.json`)
