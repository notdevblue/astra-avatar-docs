...
**후속 상태:** 사용자가 “그래 한번 계속 진행해봐.”로 아래 범위의 사본 시험을 승인했다. v011에서 실제 8본/웨이트 시험을 완료했으며 두 후보는 품질 실패로 미채택이다. [실행 결과](../v011_coat_rig/REVIEW.md)를 먼저 확인한다. 물리는 적용하지 않았다. 아래는 승인 당시 제안 기록이다.
