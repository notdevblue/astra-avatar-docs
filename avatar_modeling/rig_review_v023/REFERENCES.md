...
2026-09-09. 기존 상세 연구는 [v008 보고서](../rigging_research_v008/REPORT.md), [v015 참고 문헌](../full_rig_v015/REFERENCES.md)에 있다. 아래는 이번 추가 확인과 적용 판단이다. 관절 각도는 이 모델의 스트레스 테스트 값이며 의료적 정상 가동 범위를 정의한 것이 아니다.
...
[v008 YouTube 노트](../rigging_research_v008/YOUTUBE_NOTES.md)의 CGDive 손가락, Anthony Gibbs 어깨/팔꿈치 자료를 재사용했다. 이번 단계에 영상을 새로 끝까지 시청한 것은 아니다. 기존 설명/챕터/열람 수준은 해당 노트에 남아 있다.
