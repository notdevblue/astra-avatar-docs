...
[전체 관절 검토 보고서](v325_RIG_REVIEW.md) · [사진 갤러리](v325_GALLERY.md)
...
| `hair_00_01` | `hair_anchor_00` | 보조/제어 | 2135 / 0 | 1.86 |
| `hair_00_02` | `hair_00_01` | 보조/제어 | 1311 / 0 | 1.03 |
| `hair_tip_00` | `hair_00_02` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_wind_01` | `head` | 보조/제어 | 0 / 0 | 2.41 |
| `hair_anchor_01` | `hair_wind_01` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_01_01` | `hair_anchor_01` | 보조/제어 | 1946 / 0 | 1.86 |
| `hair_01_02` | `hair_01_01` | 보조/제어 | 1554 / 0 | 1.25 |
| `hair_tip_01` | `hair_01_02` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_wind_02` | `head` | 보조/제어 | 0 / 0 | 2.79 |
| `hair_anchor_02` | `hair_wind_02` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_02_01` | `hair_anchor_02` | 보조/제어 | 3521 / 0 | 1.69 |
| `hair_02_02` | `hair_02_01` | 보조/제어 | 2079 / 0 | 1.31 |
| `hair_tip_02` | `hair_02_02` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_wind_03` | `head` | 보조/제어 | 0 / 0 | 3.15 |
| `hair_anchor_03` | `hair_wind_03` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_03_01` | `hair_anchor_03` | 보조/제어 | 2613 / 0 | 1.54 |
| `hair_03_02` | `hair_03_01` | 보조/제어 | 1210 / 0 | 1.18 |
| `hair_tip_03` | `hair_03_02` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_wind_04` | `head` | 보조/제어 | 0 / 0 | 3.23 |
| `hair_anchor_04` | `hair_wind_04` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_04_01` | `hair_anchor_04` | 보조/제어 | 1543 / 0 | 1.73 |
| `hair_04_02` | `hair_04_01` | 보조/제어 | 606 / 0 | 1.28 |
| `hair_tip_04` | `hair_04_02` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_wind_05` | `head` | 보조/제어 | 0 / 0 | 3.00 |
| `hair_anchor_05` | `hair_wind_05` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_05_01` | `hair_anchor_05` | 보조/제어 | 1953 / 0 | 1.82 |
| `hair_05_02` | `hair_05_01` | 보조/제어 | 796 / 0 | 1.76 |
...
| `tie_01` | `tie_anchor` | 보조/제어 | 105 / 0 | 0.91 |
| `tie_02` | `tie_01` | 보조/제어 | 58 / 0 | 0.48 |
| `tie_03` | `tie_02` | 보조/제어 | 57 / 0 | 0.30 |
...
| `coat_wind_front.L` | `coat_anchor_front.L` | 보조/제어 | 0 / 0 | 2.28 |
| `coat_front_01.L` | `coat_wind_front.L` | 보조/제어 | 0 / 241 | 0.38 |
| `coat_front_02.L` | `coat_front_01.L` | 보조/제어 | 0 / 102 | 0.64 |
| `coat_front_tip.L` | `coat_front_02.L` | 보조/제어 | 0 / 0 | 0.00 |
| `coat_anchor_front.R` | `hips` | 보조/제어 | 0 / 0 | 0.00 |
| `coat_wind_front.R` | `coat_anchor_front.R` | 보조/제어 | 0 / 0 | 2.30 |
| `coat_front_01.R` | `coat_wind_front.R` | 보조/제어 | 0 / 241 | 0.90 |
| `coat_front_02.R` | `coat_front_01.R` | 보조/제어 | 0 / 102 | 0.65 |
...
| `coat_back_01.L` | `coat_wind_back.L` | 보조/제어 | 0 / 291 | 1.35 |
| `coat_back_02.L` | `coat_back_01.L` | 보조/제어 | 0 / 162 | 0.51 |
| `coat_back_tip.L` | `coat_back_02.L` | 보조/제어 | 0 / 0 | 0.00 |
| `coat_anchor_back.R` | `hips` | 보조/제어 | 0 / 0 | 0.00 |
| `coat_wind_back.R` | `coat_anchor_back.R` | 보조/제어 | 0 / 0 | 2.06 |
| `coat_back_01.R` | `coat_wind_back.R` | 보조/제어 | 0 / 295 | 0.78 |
| `coat_back_02.R` | `coat_back_01.R` | 보조/제어 | 0 / 162 | 0.55 |
