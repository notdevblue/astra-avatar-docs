...
이 작은 보정만 [v030 국소 통합 사본](../joint_checkpoint_v030/REVIEW.md)에 이어 갔다. 다른6개는 비교용이다. 초기 렌더가 생성 중인 파일을 먼저 읽어 실패했으며, 모든 후보 저장이 끝난 뒤 전체10장 렌더를 다시 실행해 완료했다. 실패한 실행을 검증 완료로 세지 않았다.
