...
- 이전에 열람한 제작자의 쇄골·twist 및 VRChat Constraint 사례는 [v025 조사](../v025_rotation_review/RESEARCH_NOTES.md)를 따른다. 이번에 영상을 추가 시청한 것은 아니다. YouTube 접근 실패를 시청/검증으로 표현하지 않는다.
