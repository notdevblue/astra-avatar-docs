...
이 표의 최대 회전은 **PhysBone OFF 관절 감사** 값이다. 헤어 본의 0°는 물리 정지를 뜻하지 않는다. 실제 이동·바람 반응은 [상세 보고 13절](v348_DETAILED_WORK_REPORT.md#motion)과 [움직임 갤러리](v348_MOTION_GALLERY.md)의 별도 60Hz 물리 기록을 따른다.

[전체 관절 검토 보고서](v348_WORK_REVIEW.md) · [사진 갤러리](v348_GALLERY.md)
...
| 본 | 부모 | Humanoid | 영향 정점 Body / Coat | 최대 로컬 회전° |
|---|---|---|---:|---:|
| `hair_wind_00` | `head` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_anchor_00` | `hair_wind_00` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_00_01` | `hair_anchor_00` | 보조/제어 | 2611 / 0 | 0.00 |
| `hair_00_02` | `hair_00_01` | 보조/제어 | 1738 / 0 | 0.00 |
| `hair_tip_00` | `hair_00_02` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_wind_01` | `head` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_anchor_01` | `hair_wind_01` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_01_01` | `hair_anchor_01` | 보조/제어 | 2226 / 0 | 0.00 |
| `hair_01_02` | `hair_01_01` | 보조/제어 | 1792 / 0 | 0.00 |
| `hair_tip_01` | `hair_01_02` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_wind_02` | `head` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_anchor_02` | `hair_wind_02` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_02_01` | `hair_anchor_02` | 보조/제어 | 3521 / 0 | 0.00 |
| `hair_02_02` | `hair_02_01` | 보조/제어 | 2079 / 0 | 0.00 |
| `hair_tip_02` | `hair_02_02` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_wind_03` | `head` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_anchor_03` | `hair_wind_03` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_03_01` | `hair_anchor_03` | 보조/제어 | 2613 / 0 | 0.00 |
| `hair_03_02` | `hair_03_01` | 보조/제어 | 1210 / 0 | 0.00 |
| `hair_tip_03` | `hair_03_02` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_wind_04` | `head` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_anchor_04` | `hair_wind_04` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_04_01` | `hair_anchor_04` | 보조/제어 | 1543 / 0 | 0.00 |
| `hair_04_02` | `hair_04_01` | 보조/제어 | 606 / 0 | 0.00 |
| `hair_tip_04` | `hair_04_02` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_wind_05` | `head` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_anchor_05` | `hair_wind_05` | 보조/제어 | 0 / 0 | 0.00 |
| `hair_05_01` | `hair_anchor_05` | 보조/제어 | 1953 / 0 | 0.00 |
| `hair_05_02` | `hair_05_01` | 보조/제어 | 796 / 0 | 0.00 |
...
| `tie_01` | `tie_anchor` | 보조/제어 | 105 / 0 | 0.00 |
| `tie_02` | `tie_01` | 보조/제어 | 58 / 0 | 0.00 |
| `tie_03` | `tie_02` | 보조/제어 | 57 / 0 | 0.00 |
...
| `coat_wind_front.L` | `coat_anchor_front.L` | 보조/제어 | 0 / 0 | 0.00 |
| `coat_front_01.L` | `coat_wind_front.L` | 보조/제어 | 0 / 241 | 0.00 |
| `coat_front_02.L` | `coat_front_01.L` | 보조/제어 | 0 / 102 | 0.00 |
| `coat_front_tip.L` | `coat_front_02.L` | 보조/제어 | 0 / 0 | 0.00 |
| `coat_anchor_front.R` | `hips` | 보조/제어 | 0 / 0 | 0.00 |
| `coat_wind_front.R` | `coat_anchor_front.R` | 보조/제어 | 0 / 0 | 0.00 |
| `coat_front_01.R` | `coat_wind_front.R` | 보조/제어 | 0 / 241 | 0.00 |
| `coat_front_02.R` | `coat_front_01.R` | 보조/제어 | 0 / 102 | 0.00 |
| `coat_front_tip.R` | `coat_front_02.R` | 보조/제어 | 0 / 0 | 0.00 |
| `coat_anchor_back.L` | `hips` | 보조/제어 | 0 / 0 | 0.00 |
| `coat_wind_back.L` | `coat_anchor_back.L` | 보조/제어 | 0 / 0 | 0.00 |
| `coat_back_01.L` | `coat_wind_back.L` | 보조/제어 | 0 / 291 | 0.00 |
| `coat_back_02.L` | `coat_back_01.L` | 보조/제어 | 0 / 162 | 0.00 |
| `coat_back_tip.L` | `coat_back_02.L` | 보조/제어 | 0 / 0 | 0.00 |
| `coat_anchor_back.R` | `hips` | 보조/제어 | 0 / 0 | 0.00 |
| `coat_wind_back.R` | `coat_anchor_back.R` | 보조/제어 | 0 / 0 | 0.00 |
| `coat_back_01.R` | `coat_wind_back.R` | 보조/제어 | 0 / 295 | 0.00 |
| `coat_back_02.R` | `coat_back_01.R` | 보조/제어 | 0 / 162 | 0.00 |
