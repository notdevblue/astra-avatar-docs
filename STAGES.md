...
| v351 | [연결 UV·iPhone 준비](avatar_modeling/v351_conventional_uv/v351_WORK_REVIEW.md) | 작업 후보·표정 미구현·[눈 우선 점검 등록](avatar_modeling/v351_conventional_uv/v351_EYE_REVIEW_TASKS.md)·[과한 명암 개선 등록](avatar_modeling/v351_conventional_uv/v351_PAINTED_SHADOW_TASKS.md)·[작업 플로우](avatar_modeling/v351_conventional_uv/v351_WORKFLOW.md) |
